...
public class Tester {
    ...
    public static void main(String args[]) throws Exception {
        ...
        int numdimensions = 1; // Options: 1, 2, 3

        // Data distribution?
        Option op = Option.UNIFORM; // Options: Option.UNIFORM, Option.SHAPE, Option.RANDOM,
        ...
        switch(numdimensions) { // dimension
            case 1: // Test for 1D points
                ...
                System.out.print("For reference, a lower bound on the height of a tree with "+ tree.size() + " leaves is ceil(");
                ...
                System.out.println("\n\nNote : For a valid tree, each internal node should have exactly 2 children with no datapoints stored in it and\n " +
                        "each leaf should have 0 children with exactly one datapoint stored in it. This validity check is not being done\n" +
                		"in the Tester but it will be done in the Grader.   We advise you to write your own validity check.");
                //  query points
